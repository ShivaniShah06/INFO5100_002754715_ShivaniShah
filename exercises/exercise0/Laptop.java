...
public class Laptop {
    ...
    class Processor {
        ...
        public Processor(String processorCore){
            core = processorCore;
            System.out.println("Created nested class instance: " +UUID.randomUUID().toString() + "of" +core + " for `Processor` subclass of the `Laptop` class.");
        }
    ...
    class OperatingSystem {
        ...
        public OperatingSystem(String operatingOS){
            OS = operatingOS;
            System.out.println("Created nested class instance: " +UUID.randomUUID().toString() + "of" +OS + " for `OperatingSystem` subclass of the `Laptop` class.");
        }

        //nested class method
        void provideServices(){
            System.out.println("This is `provideServices()` method output for `OperatingSystem` subclass of the `Laptop` class.");
        }
    }
